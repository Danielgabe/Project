...
public class UpdateServiceGroupTask extends AsyncTask<String, Void, TransferSurveyorService> {

	private String service="";
	ProgressDialog pDialog;
	private static String KEY_SUCCESS="true";
	private static String KEY_MESSAGESTATUS="success";	private Activity activity;
	
	public UpdateServiceGroupTask(Activity activity)
	{
	...
	protected void onPostExecute(TransferSurveyorService resultData) {
		...
		if (service.equals("updateServiceGroup") && resultData.getMessageStatus().equals(KEY_MESSAGESTATUS)
